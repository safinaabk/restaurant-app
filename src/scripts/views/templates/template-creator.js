...
const createRestaurantItemTemplate = (restaurant) => `
  <div class="resto_item">
    ...
    <div class="item_body">
      <div class="itm_body_name"><a href="/#/detail/${restaurant.id}">${restaurant.name}</a></div>
...
export { createRestoDetailTemplate, createRestaurantItemTemplate, createReviewTemplate, createLikeButtonTemplate, createLikedButtonTemplate };
